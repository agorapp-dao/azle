 ...
 */
function setTimerInterval(interval, callback) {
    if (globalThis._azleIc === undefined) {
        return undefined;
    }
    const timerCallbackId = `_interval_timer_${(0, uuid_1.v4)()}`;
    const timerId = (0, decode_1.decode)(nat64_1.nat64, globalThis._azleIc.setTimerInterval((0, encode_1.encode)(nat64_1.nat64, interval).buffer, timerCallbackId));
...
exports.setTimerInterval = setTimerInterval;
