...
async function azle() {
    ...
    await (0, utils_1.time)(`\nBuilding canister ${(0, colors_1.green)(canisterName)}`, 'default', async () => {
        ...
        const compilationResult = await (0, compile_typescript_code_1.compileTypeScriptToJavaScript)(canisterConfig.main, canisterConfig);
        ...
        await (0, compile_rust_code_1.compileRustCode)(canisterName, canisterPath, stdioType);
    });
