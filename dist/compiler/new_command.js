...
exports.generateNewAzleProject = void 0;
const fs_1 = require("fs");
const path_1 = require("path");
function generateNewAzleProject(azleVersion, dfxVersion) {
    ...
    const packageJson = generatePackageJson(azleVersion, dfxVersion, projectName);
    const dfxJson = generateDfxJson(projectName);
    const gitignore = generateGitignore();
    const indexTs = generateIndexTs();
    const readmeMd = generateReadmeMd(projectName);
    const projectPath = (0, path_1.join)(projectName, 'src');
    if (!(0, fs_1.existsSync)(projectPath)) {
        (0, fs_1.mkdirSync)(projectPath, {
            recursive: true
        });
    }
    (0, fs_1.writeFileSync)((0, path_1.join)(projectName, 'tsconfig.json'), tsconfig);
    (0, fs_1.writeFileSync)((0, path_1.join)(projectName, 'package.json'), packageJson);
    (0, fs_1.writeFileSync)((0, path_1.join)(projectName, 'dfx.json'), dfxJson);
    (0, fs_1.writeFileSync)((0, path_1.join)(projectName, '.gitignore'), gitignore);
    (0, fs_1.writeFileSync)((0, path_1.join)(projectName, 'src', 'index.ts'), indexTs);
    (0, fs_1.writeFileSync)((0, path_1.join)(projectName, 'README.md'), readmeMd);
}
exports.generateNewAzleProject = generateNewAzleProject;
...
function generatePackageJson(azleVersion, dfxVersion, projectName) {
    return `{
    "scripts": {
...
function generateDfxJson(projectName) {
    return `{
    "canisters": {
        "${projectName}": {
            "type": "custom",
...
function generateReadmeMd(projectName) {
    return `# ${projectName}
